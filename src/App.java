...
public class App {
    ...
    // currentIndex is static because it's shared across all uses of the App class. since the main method is static, any variable used there needs to be static too. 
    // this way, currentIndex can be accessed and updated without needing to create an instance of the class. it keeps track of the current item in the list across multiple button clicks.
